...
export default function Projects() {
  ...
  return (
    <section id="projects" className="custom-bg py-10 md:min-h-screen">
        ...
        <div className="relative">
              ...
              {projects
                ...
                .map((project) => (
                  <motion.div
                    ...
                    key={project.id}
                    layout="position"
                    className="group flex h-fit snap-start flex-col items-center rounded-md active:scale-90"
                  >
                    <h2
                      {...textVarient}
                    ...
                    <div className="relative flex aspect-video w-80 items-center justify-center rounded-md border border-black-700 bg-black bg-opacity-25 shadow-lg shadow-black backdrop-blur-sm backdrop-filter sm:w-96">
                      ...
                      <div
                        onClick={() =>
                          setActiveModal({ active: true, project })
                        }
          ...
          {(window.innerWidth < 1379 ||
            ...
            <>
              ...
              <button
                onClick={slidePrev}
                className="absolute top-0 bottom-0 left-0 my-auto aspect-square h-fit w-fit rounded-full border-2 bg-black bg-opacity-10 p-2 backdrop-blur-sm transition-all duration-300 ease-in-out hover:scale-125 hover:opacity-100 active:scale-75"
              >
              ...
              <button
                onClick={slideNext}
                className="absolute top-0 bottom-0 right-0 my-auto aspect-square h-fit w-fit rounded-full border-2 bg-black bg-opacity-10 p-2 backdrop-blur-sm transition-all duration-300 ease-in-out hover:scale-125 hover:opacity-100 active:scale-75"
              >
